...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		//初始化数据 收入类型表格
		db.execSQL("insert into tb_itype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"1","实习工资"});
		db.execSQL("insert into tb_itype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"2","还款"});
		db.execSQL("insert into tb_itype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"3","奖学金"});
		db.execSQL("insert into tb_itype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"4","衣服"});
		db.execSQL("insert into tb_itype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"5","旧物件"});
		db.execSQL("insert into tb_itype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"6","助学金"});
		db.execSQL("insert into tb_itype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"7","捡钱"});
		...
		db.execSQL("insert into tb_itype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"11","生活费"});
		...
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"4","学费"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"5","夜宵"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"6","生活用品"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"7","学习用品"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"8","衣服"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"9","应酬"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"10","电子产品"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"11","食品"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"12","充话费"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"13","充一卡通"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"14","打的"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"15","充公交卡"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"16","其他"});
		db.execSQL("insert into tb_ptype(_id,no,typename) values(?,?,?)",new String[]{String.valueOf(100000001),"17","语音识别"});
	}
